...
# model 저장된 경로
MODEL_PATH = '~/dncskin_classification/workspace/data/dog/result_cla/multi_A4_A5_A6/model'

# test 결과를 저장할 경로의 상위 경로
TEST_RESULT_ROOT = '~/dncskin_classification/workspace/data/dog'

# test tfrecord 저장된 경로
TEST_PATH = f"{TEST_RESULT_ROOT}/tfrc_cla/tfrecord_A4_A5_A6/test"

# test log, confusion matrix 저장할 폴더 경로
TEST_FOLDER = f"{TEST_RESULT_ROOT}/result_cla/multi_A4_A5_A6"
